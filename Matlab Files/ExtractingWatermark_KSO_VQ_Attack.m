% This file extracts watermark from image that has been vector quantised
% with Kohonen Self Organising Feature Map CB
close all;clear all;clc;

% Read in estimated polarities... 
est_polarity1 = fread3('Stage 1\Polarity1.Y',0,0,128,128)';
est_polarity2 = fread3('Stage 1\Polarity2.Y',0,0,128,128)';
est_polarity3 = fread3('Stage 1\Polarity3.Y',0,0,128,128)';
